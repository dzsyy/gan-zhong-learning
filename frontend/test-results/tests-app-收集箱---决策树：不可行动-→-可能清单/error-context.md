...
- Name: tests/app.spec.ts >> 收集箱 - 决策树：不可行动 → 可能清单
- Location: tests/app.spec.ts:20:1
...
Locator:  locator('.task-item').first()
...
Call log:
  ...
  - waiting for locator('.task-item').first()
    9 × locator resolved to <div class="task-item">…</div>
