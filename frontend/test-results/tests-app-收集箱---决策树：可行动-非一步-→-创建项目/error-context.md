...
- Name: tests/app.spec.ts >> 收集箱 - 决策树：可行动+非一步 → 创建项目
- Location: tests/app.spec.ts:68:1
...
Locator: locator('.project-name').first()
Expected substring: "复杂项目"
Received string:    "快速任务"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.project-name').first()
    9 × locator resolved to <div class="project-name">快速任务</div>
      - unexpected value "快速任务"
...
- generic [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e21] [cursor=pointer]:
      ...
      - generic [ref=e23]: 归档
  - generic [ref=e25]:
    - heading "项目清单" [level=1] [ref=e27]
    - generic [ref=e29] [cursor=pointer]:
      - generic [ref=e30]: 快速任务
      - generic [ref=e31]: 统筹谋划
      - generic [ref=e33]: 0/0 粉末任务
```
