...
- Name: tests/app.spec.ts >> 收集箱 - 决策树：可行动+一步搞定 → 执行清单
- Location: tests/app.spec.ts:43:1
...
Locator: locator('.execution-title').first()
Expected substring: "快速任务"
Received string:    "需要等待的任务"
Timeout: 5000ms

Call log:
  - Expect "toContainText" with timeout 5000ms
  - waiting for locator('.execution-title').first()
    9 × locator resolved to <div class="execution-title ">需要等待的任务</div>
      - unexpected value "需要等待的任务"
...
- generic [ref=e3]:
  - generic [ref=e4]:
    ...
    - generic [ref=e21] [cursor=pointer]:
      ...
      - generic [ref=e23]: 归档
  - generic [ref=e25]:
    - heading "执行清单" [level=1] [ref=e27]
    - generic [ref=e29]:
      - generic [ref=e31]:
        - generic [ref=e32]: 需要等待的任务
        - generic [ref=e33]: 收集箱
      - generic [ref=e34]:
        - button "完成" [ref=e35] [cursor=pointer]
        - button "移入回收箱" [ref=e36] [cursor=pointer]
```
