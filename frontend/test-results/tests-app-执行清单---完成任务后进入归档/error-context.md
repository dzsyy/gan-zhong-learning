...
- Name: tests/app.spec.ts >> 执行清单 - 完成任务后进入归档
- Location: tests/app.spec.ts:130:1
...
Call log:
  - waiting for locator('.btn-ghost:has-text("完成")').first()
